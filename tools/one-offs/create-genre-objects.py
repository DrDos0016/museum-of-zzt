...
GENRES = {
    ...
    "Beta": "Files containing content that is generally feature complete, but not yet fully tested or publicly released (until now)",
    ...
    "Demo": "Files containing publicly released and incomplete content to promote an upcoming world before its completion.",
    ...
    "Engine": "Files containing content showcasing a unique type of gameplay via the use of ZZT's objects. This may be a full game, or a proof-of-concept demonstrating a single usage of the engine. Common types of engines such as shooters, platformers, RPGs, etc. have their own dedicated genres as well.",
    ...
    "Ludum Dare": "Files containing content created for the Ludum Dare game jam event. Entrants have either 48 or 72 hours to create a game adhering to a topic.",
    ...
    "Multiplayer": "Files containing content intended for multiple players to participate together.",
    ...
    "Retro": "Files which deliberately use the aesthetics and design principles seen in older ZZT worlds.",
    ...
    "Shooter": "Files that contain content focused primarily on shooting, typically done via some sort of vehicle rather than having the player shoot directly.",
