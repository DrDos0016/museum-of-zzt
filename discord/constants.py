...
:art: *The Joy of ZZT* (2020) - <https://museumofzzt.com/series/8/the-joy-of-zzt/?sort=date> YouTube series depicting the full creation of a ZZT world designed for newcomers. A gentle introduction to ZZT-OOP all the way through creating a unique engine
:tools: *Modern Tools and Resources* (2021) - <https://museumofzzt.com/article/view/651/modern-tools-and-resources/> - A slightly more in-depth look at some of the tools used for creating ZZT worlds.
:blue_book: *The Unofficial ZZT Player's Manual* (2022) - <https://museumofzzt.com/article/view/737/the-unofficial-zzt-players-manual/> - Guide to getting started playing ZZT, downloading engines, basic gameplay elements, cheats, and a complete overview of all the elements that make up ZZT worlds.
:computer: *ZZT-OOP 101* (2022) - <https://museumofzzt.com/article/view/747/zzt-oop-101/> - A beginner oriented guide to ZZT-OOP programming
:pencil: *Learning ZZT-OOP By Example* (2022) - <https://museumofzzt.com/article/view/756/learning-zzt-oop-by-example-with-examplia/> - Practical demonstrations of every ZZT-OOP command with an accompanying example world. Going through all the code and explaining the hows and whys of ZZT-OOP programming.
:floppy_disk: *ZZT to the Masses* (2020) - <https://museumofzzt.com/article/view/490/zzt-to-the-masses-publishing-to-the-museum-and-itchio/> - Guide for publishing ZZT worlds onto Itch.io and the Museum of ZZT. Plus how to set up a web version of Zeta in order to allow your game to be played directly in a web browser.
...
:trophy: *The Best of ZZT* (2018) - <https://museumofzzt.com/article/view/295/the-best-of-zzt/> - Recommendations focused on traditional ZZT gameplay, well-polished titles, unexpected gameplay styles, artistic endeavors, and a few generic suggestions for types of worlds to keep an eye opened for.
:trophy: *The Best of ZZT Part 2 - Modern Treasures* (2021) - <https://museumofzzt.com/article/view/563/the-best-of-zzt-part-2-modern-treasures/> - Recommendations focused on worlds created by the present day ZZT community, as well as a few fun older titles that were overlooked in the previous article.
