...
class ZFile_Sorter(Sorter):
    sort_options = [
        ...
        {"tag": "basic", "text": "Release Date (Newest)", "val": "-release", "db_ordering": ["-year", "-release_date", "sort_title"]},
        {"tag": "basic", "text": "Release Date (Oldest)", "val": "release", "db_ordering": ["year", "release_date", "sort_title"]},
        ...
        {"tag": "featured", "text": "Recently Featured", "val": "recent", "db_ordering": "SPECIAL"},
        {"tag": "debug", "text": "!ID (Newest)", "val": "-id", "db_ordering": ["-id"]},
        {"tag": "debug", "text": "!ID (Oldest)", "val": "id", "db_ordering": ["id"]},
    ]
